...
def main(args, video_path, data_root):
    ...
    val_ids_path = "/home/jonghee/Dataset/ActivityNetCaptions/captions/val_ids.json"
    with open(val_ids_path, 'r') as file:
        val_list = json.load(file)

    if video_prefix not in val_list:
        return 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_path', type=str,
                        default=osp.join("/home/jonghee/Dataset/ActivityNet/v1-2/val"),
                        help="path to the videos to be processed, please use absolute path")

    parser.add_argument('--save_data_root_path', type=str,
                        default="/home/previ01/changjun/vmr_baseline/shot_detection/shot_detection_result",
